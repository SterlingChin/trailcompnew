// angular.module('trail').controller('weatherCtrl', function($scope, mainSvc) {
//     weatherSvc.getWeather(mainSvc.location.lat, mainSvc.location.long).then(function(weatherObject) {
...
//     });
//
//     forecastSvc.getForecast(mainSvc.location.lat, mainSvc.location.long).then(function(forecastObject) {
